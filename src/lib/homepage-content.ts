  ...
  heroSlides: [
    {
      ...
      subtitle: "Pamper your pet with luxury bath and styling treatments.",
      image: "/images/banner_grooming_desktop.png",
      mobileImage: "/images/banner_grooming_mobile.png",
      overlayOpacity: 0,
      textPosition: "left",
      sortOrder: 1,
      isActive: true,
    ...
    {
      title: "Luxury Pet Hotel & Boarding",
      subtitle: "Comfortable, monitored overnight stays for peace of mind.",
      image: "/images/banner_boarding_desktop.png",
      mobileImage: "/images/banner_boarding_mobile.png",
      overlayOpacity: 0,
      textPosition: "left",
      sortOrder: 2,
      isActive: true,
      cta: "Book Boarding",
      href: "/book?service=boarding",
      secondary: "WhatsApp Us",
      secondaryHref: "https://wa.me/916358848177",
    },
    {
      title: "Social Daycare & Play",
      subtitle: "Supervised play areas for daily exercise and enrichment.",
      image: "/images/banner_daycare_desktop.png",
      mobileImage: "/images/banner_daycare_mobile.png",
      overlayOpacity: 0,
      textPosition: "left",
      sortOrder: 3,
      isActive: true,
      cta: "Book Daycare",
      href: "/book?service=daycare",
      secondary: "Explore Services",
      secondaryHref: "#services",
    },
    {
      title: "Premium Swimming Pool",
      subtitle: "Healthy splashing fun in a crystal-clear pet pool.",
      image: "/images/banner_swimming_desktop.png",
      mobileImage: "/images/banner_swimming_mobile.png",
      overlayOpacity: 0,
      textPosition: "left",
      sortOrder: 4,
      isActive: true,
